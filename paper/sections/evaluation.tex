...
\begin{figure}[h]
    ...
    \caption{Unified MoM evaluation pipeline. The system parallelizes assessment across the model registry, managing dynamic dataset loading and comparative metric generation for merged and LoRA variants.}
